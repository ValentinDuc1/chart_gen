...
Examples:
  ...
  python generate_random.py --one-of-each
    ...
    parser.add_argument(
        '-t', '--types',
        nargs='+',
        choices=['line', 'bar', 'horizontal_bar', 'pie', 'scatter', 'grouped_bar', 'stacked_bar', 'box', 'area', 'discrete_distribution', 'hist2d', 'cohere', 'signal_pair', 'timeline', 'heatmap', 'streamplot'],
